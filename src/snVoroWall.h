...
/*
struct wall_trianglemesh : public wall {
	public:
		wall_trianglemesh(snCore::snMesh * in_pMesh,int iw_id=-99)
		: mpMesh(in_pMesh), w_id(iw_id) {};
